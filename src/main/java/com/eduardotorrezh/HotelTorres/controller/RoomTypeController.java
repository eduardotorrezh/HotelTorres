...
public class RoomTypeController {
    ...
    @GetMapping("/{id}")
    ResponseEntity<ResponseDTO<RoomTypeDTO>> getObjectById(@PathVariable long id) throws Exception {
        RoomTypeDTO roomTypeDTO = roomTypeService.getObjectById(id);
        ResponseDTO responseDTO = new ResponseDTO(Boolean.TRUE, roomTypeDTO);
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
